...
//     */
//    public DendrogramLayout(String group, String relHorizontalPositionPropertyName) {
//        super(group);
//        this.relHorizontalPositionPropertyName = relHorizontalPositionPropertyName;
...
//                int pX = 0;
//                if (p != null) {
//                    pX = p.getInt(relHorizontalPositionPropertyName);
//                }
//                int rx = n.getInt(relHorizontalPositionPropertyName);
//
//                int x = pX + rx;
//                int scaledX = x + (SCALE_FACTOR * rx);
//                if (p != null) {
//                    n.setInt(relHorizontalPositionPropertyName, scaledX);
//                }
//                setX(n, p, m_ax + scaledX);
////                System.out.println(m_ax + " " + d + " " + pX + "  " + rx + "  " + x);
//                break;
//            case Constants.ORIENT_RIGHT_LEFT:
