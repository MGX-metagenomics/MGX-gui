...
/**
 * <p>Graph subclass that models a tree structure of hierarchical parent-child
 ...
 * source and target key field names are renamed to
 * {@link #DEFAULT_SOURCE_KEY} and {@link #DEFAULT_TARGET_KEY}. Like the {@link Graph}
 * class, Trees are backed by node and edge tables, and use {@link prefuse.data.Node}
 * and
...
public class Tree extends Graph {
     ...
     * Create a new Tree.
     *
     * @param nodes the backing table to use for node data. Node instances of
     ...
     * actually a child of the given parent node, or either node is invalud.
     */
     ...
     * of 0, with each child at a greater depth level. -1 is returned if the
    ...
    public boolean isValidTree() {
        ...
        while (nodes.hasNext()) {
            ...
            if (n == root && id > 0) {
                ...
                s_logger.log(Level.WARNING, "Node {0} has multiple parents.", n);
                return false;
            }
        }
        ...
        if (counts[0] < nedges) {
            s_logger.log(Level.WARNING, "Not all of the tree was visited. " + "Only {0}/{1} edges encountered", new Object[]{counts[0], nedges});
            return false;
        }
        return true;
    }
