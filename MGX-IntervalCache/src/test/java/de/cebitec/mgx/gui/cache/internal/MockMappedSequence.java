 ...
 * @author sjaenick
 */
public class MockMappedSequence extends MappedSequenceI {

    private final long seq_id;
    private final float identity; // range 0-100

    public MockMappedSequence(long seq_id, int start, int stop, float identity) {
        super(start, stop);
        this.seq_id = seq_id;
    ...
    public boolean equals(Object obj) {
        ...
        final MockMappedSequence other = (MockMappedSequence) obj;
