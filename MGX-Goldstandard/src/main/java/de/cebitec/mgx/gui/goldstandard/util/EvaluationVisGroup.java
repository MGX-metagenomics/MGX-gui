...
import static de.cebitec.mgx.api.groups.VisualizationGroupI.VISGROUP_ACTIVATED;
import static de.cebitec.mgx.api.groups.VisualizationGroupI.VISGROUP_CHANGED;
import static de.cebitec.mgx.api.groups.VisualizationGroupI.VISGROUP_DEACTIVATED;
import static de.cebitec.mgx.api.groups.VisualizationGroupI.VISGROUP_HAS_DIST;
import static de.cebitec.mgx.api.groups.VisualizationGroupI.VISGROUP_RENAMED;
...
import de.cebitec.mgx.common.AttributeTypeFetcher;
import de.cebitec.mgx.common.DistributionFactory;
import de.cebitec.mgx.common.DistributionFetcher;
import de.cebitec.mgx.common.HierarchyFetcher;
import de.cebitec.mgx.common.MultiAttributeTypeFetcher;
 ...
 * @author pblumenk
 */
public class EvaluationVisGroup implements VisualizationGroupI{
    ...
    public EvaluationVisGroup(VGroupManagerI vgmgr, int id) {
        this.id = id;
...
//              distFetcher.execute();
    ...
    private Set<JobI> getJobsProvidingAttributeType(SeqRunI run, final String attrTypeName) {
        ...
        for (Map.Entry<JobI, Set<AttributeTypeI>> entrySet : attributeTypes.get(run).entrySet()) {
    ...
    public Map<SeqRunI, Set<AttributeI>> getSaveSet(List<String> requestedAttrs) {
        ...
        for (Map.Entry<SeqRunI, DistributionI<Long>> e : currentDistributions.entrySet()) {
