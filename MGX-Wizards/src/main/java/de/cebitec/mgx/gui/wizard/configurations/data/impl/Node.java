...
public class Node {
   ...
   public Node(String lClassName, String lId) {
	...
	configItems = new TreeMap<String, ConfigItem>();
   }
   ...
   /**
    * Gibt die Antworten in einer Map zurück.
    * Der Schlüssel, ist dabei der eindeutige Name des ConfigItems.
    * ConfigItems, dessen Antwort leer ist, oder nicht gesetzt wurde, werden
    * gelöscht.
    * 
