...
// @ActionID(category="...", id="de.cebitec.mgx.gui.wizard.extract.DNAExtractWizardAction")
// @ActionRegistration(displayName="Open DNAExtract Wizard")
