...
import de.cebitec.mgx.gui.mapping.misc.Observable;
import de.cebitec.mgx.gui.mapping.misc.Observer;
...
public class MenuLabel extends JLabel implements Observer, Observable {
    ...
    public MenuLabel(JPanel associatedPanel, String title){
        ...
        expandIcon = new ImageIcon(this.getClass().getClassLoader().getResource("de/cebitec/mgx/gui/mapping/viewer/expandIcon.png"));
         collapseIcon = new ImageIcon(this.getClass().getClassLoader().getResource("de/cebitec/mgx/gui/mapping/viewer/collapseIcon.png"));
