...
public class SubDistCustomizer extends javax.swing.JPanel implements ItemListener {
    ...
    private VisualizationGroupI currentGroup = null;
    ...
    public void setAttributeType(AttributeTypeI aType) {
        ...
        try {
            Pair<VisualizationGroupI, DistributionI<Long>> p = VGroupManager.getInstance().getDistributions().get(0);
    ...
    public void itemStateChanged(ItemEvent ie) {
        if (ie.getStateChange() == ItemEvent.SELECTED) {
            ...
            Pair<VisualizationGroupI, DistributionI<Long>> p;
            try {
