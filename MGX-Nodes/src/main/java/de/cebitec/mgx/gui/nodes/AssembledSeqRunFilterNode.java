 ...
 * @author sjaenick
 */
public class AssembledSeqRunFilterNode extends FilterNode implements NodeListener {

    private final AssembledSeqRunNode n;
    private final AssemblyGroupI vGroup;

    public AssembledSeqRunFilterNode(AssembledSeqRunNode node, AssemblyGroupI vGroup) {
        ...
        n = node;
        this.vGroup = vGroup;
        super.setShortDescription(getToolTipText(node.getContent().getSeqRun()));
    ...
    private String getToolTipText(SeqRunI run) {
        return new StringBuilder("<html><b>Sequencing run: </b>")
                .append(escapeHtml4(run.getName()))
