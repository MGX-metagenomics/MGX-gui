...
public class AnnotateAssembly extends NodeAction implements LookupListener {
    ...
    public AnnotateAssembly() {
        this(Utilities.actionsGlobalContext());
    }

    private AnnotateAssembly(Lookup context) {
        putValue(NAME, "Annotate");
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        try {
            ...
            while (pTools.hasNext()) {
                ToolI t = pTools.next();
                if (t.getScope() == ToolScope.GENE_ANNOTATION) {
                    projectTools.add(t);
                }
            }
        ...
        if (DialogDisplayer.getDefault().notify(wiz) == WizardDescriptor.FINISH_OPTION) {
            ...
            for (final AssemblyI asm : assemblies) {
                ...
                if (tooltype == ToolType.USER_PROVIDED) {
                    ...
                    submitTask = new SubmitTask(toolName, toolDesc, toolAuthor, toolWebsite, toolVersion, toolXML, asm, params, toolIsCreated, submissionRateLimit);
                } else {
                    submitTask = new SubmitTask(toolId, toolName, tooltype, asm, params, toolIsCreated, submissionRateLimit);
                }
    ...
    private final static class SubmitTask extends MGXTask {
        ...
        private long toolId;
        private final AssemblyI asm;
        private final ToolType tooltype;
        private final List<JobParameterI> params;
        private final CountDownLatch toolCreated;
        private final Semaphore rateLimit;

        public SubmitTask(long toolId, String toolName, ToolType tooltype, AssemblyI asm, List<JobParameterI> params, CountDownLatch toolCreated, Semaphore rateLimit) {
            super("Submit " + asm.getName() + " / " + toolName);
            if (toolName == null) {
        ...
        public SubmitTask(String toolName, String toolDesc, String toolAuthor, String toolUri, float toolVersion, String toolXML, AssemblyI asm, List<JobParameterI> params, CountDownLatch toolCreated, Semaphore rateLimit) {
            super("Submit " + asm.getName() + " / " + toolName);
        ...
        public boolean process() {
            final MGXMasterI master = asm.getMaster();
            ...
            try {
                ...
                JobI job = master.Job().create(selectedTool, params, asm);
