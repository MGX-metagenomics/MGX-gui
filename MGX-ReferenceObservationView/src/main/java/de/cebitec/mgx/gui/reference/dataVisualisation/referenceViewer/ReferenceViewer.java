...
import de.cebitec.mgx.gui.reference.util.polyTree.Node;
import de.cebitec.mgx.gui.reference.util.polyTree.NodeVisitor;
import de.cebitec.mgx.gui.reference.util.polyTree.Polytree;
...
import de.cebitec.mgx.gui.reference.dataVisualisation.abstractViewer.PaintingAreaInfo;
